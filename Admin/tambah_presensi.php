...
if (isset($_POST['simpan'])) {
    if (empty($_POST["no_anggota"]) || empty($_POST["tanggal"])) {
        $gagal = "Nama Anggota dan Tanggal tidak boleh kosong!!";
    } else {
        ...
        if (mysqli_affected_rows($koneksi) != 0) {
            $tanggall = date("d-m-Y", strtotime($tanggal));
            $gagal = "$no_anggota Telah Melakukan Presensi pada $tanggall";
        } else {

            $query = mysqli_query($koneksi, "insert into absen values('$tanggal','$no_anggota','$jam_masuk','$jam_keluar', '$keterangan','$status_absen')");
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <p>></p>
                        <p style="font-size: 12px;">&nbsp&nbsp&nbsp&nbspTAMBAH PRESENSI</p>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                <label>Nama</label><br>
                                                <select class="form-control" aria-label="Default select example" name="no_anggota">
                                                    <option value="" selected>--------Nama Anggota--------</option>
                                                    <?php
                                                    ...
                                                    ?>
                                                        ...
                                                        <option value="<?php echo $tampil['no_anggota']; ?>"><?php echo $tampil['no_anggota'] . " - " . $tampil['nama']; ?></option>
