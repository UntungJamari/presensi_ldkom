                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <div class="row">
                                                                <a href="edit_tamu.php?id=<?php echo $tampil['id']; ?>"><button type="button" class="btn btn-outline-warning btn-sm" style="font-size: 10px;">Edit</button></a>
                                                                <a href="tamu.php?id=<?php echo $tampil['id']; ?>" onclick="return confirm('Apakah Anda yakin menghapus data ini? semua data yang berkaitan akan hilang!!')"><button type="button" class="btn btn-outline-danger btn-sm" style="font-size: 10px;">Hapus</button></a>
                                                            </div>
                                                        </center>
                                                    </td>
                                                </tr>
